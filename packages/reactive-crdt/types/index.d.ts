...
export declare function crdtValue<T extends NestedSchemaType>(value: T | Y.Array<any> | Y.Map<any>): CRDTArray<any> | CRDTObject<any> | (T & string) | (T & Y.XmlFragment) | (T & Y.XmlHook) | (T & Y.Text) | (T & Box<any>) | (T & number) | (T & boolean);
